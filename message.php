...
<div class="mytable">
<h2 align="center" >Messages-Inbox</h2>
...
if (!$select_db){
    ...
    $query="SELECT * from pm WHERE username='".$_SESSION['username']."'";
...
?>
          <tr>
            ...
            <a href="reply.php?id=<?php echo $user_id; ?>">Reply Message</a>
          </td>
        </tr>
